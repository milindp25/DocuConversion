/**
 * Signup page for DocuConversion.
 * Provides OAuth sign-up options (Google, GitHub).
 * OAuth signup and signin are equivalent for new users.
 * Email/password registration coming in a future update.
 */
        ...
        <div className="rounded-2xl border border-gray-800 bg-gray-900/80 p-8 shadow-xl shadow-black/20 backdrop-blur-sm">
          ...
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="mt-2 text-sm text-gray-400">
              Get started with free PDF tools
            </p>
          </div>
