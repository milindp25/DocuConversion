/**
 * Word to PDF conversion tool page.
 * Converts Word (.doc, .docx) documents to PDF format.
 */
...
export default function WordToPdfPage() {
  ...
  return (
    ...
    >
      <FileUploader
        acceptedTypes={ACCEPTED_FILE_TYPES.WORD}
      ...
      {job?.status === "completed" && job.downloadUrl && (
        <div className="flex justify-center">
          <DownloadButton
            ...
            fileName={
              file?.name.replace(/\.(docx?|DOCX?)$/, ".pdf") ?? "document.pdf"
            }
          />
        </div>
      )}
